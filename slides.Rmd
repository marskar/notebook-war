...
![](https://i.vimeocdn.com/video/474129126_1280x720.jpg)
...
3. configure Jupyter Notebooks to run on markdown (md) files with [notedown](https://github.com/aaren/notedown)
...
- Definitions
    - Classes
    - Functions
- [Type Hints](https://docs.python.org/3/library/typing.html) (for more check out Steven Lott's PyData DC tutorial)
...
- [doctest](https://docs.python.org/3/library/doctest.html) -> test suite (with [`unittest` API](https://docs.python.org/3/library/doctest.html#unittest-api))
